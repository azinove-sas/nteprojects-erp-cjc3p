          ...
          >
            ...
            >
              ...
              >
                ...
                >
                  <Image
                    src="/static/images/nteprojects-logo.webp"
                    height={50}
                  />
                </Text>
              </Text>
                ...
                >
                  ...
                  >
                    ...
                    >
                      ...
                      >
                        {userData.user.role == 0 && <>User</>}
                        {userData.user.role == 1 && <>Admin</>}
                        {userData.user.role == 2 && <>Super Admin</>}
                      </Box>
                    </Box>
                  </Box>
                  <Box
                  ...
                  <Text
                    ...
                    onClick={() =>
                      signOut({
                        callbackUrl: `${process.env.NEXT_PUBLIC_URL}/api/auth/logout`,
                      })
                    }
                    sx={{
                      borderRadius: "0.375rem",
